(function () {
  ...
  try {
      try {
        ...
        fbq('init', '1777746619134979');
    fbq('set', 'autoConfig', 'false', '1777746619134979');
    __adroll.fb=true;

    var __fbcd = {segment_eid: "L6UU6AYZEJBZZOMQ64YHQJ"};
    ...
    var __fbcd = {event: "EventSegment", segment_eid: "L6UU6AYZEJBZZOMQ64YHQJ"};
    for (var prop in __adroll.get_external_data()){
        __fbcd['ar_' + prop] = __adroll.get_external_data()[prop];
    }
  ...
  if (typeof __adroll.set_pixel_cookie != 'undefined') {__adroll.set_pixel_cookie(adroll_adv_id, adroll_pix_id, "L6UU6AYZEJBZZOMQ64YHQJ");}
}());
